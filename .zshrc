...
alias brewall='brew update && brew upgrade --greedy && brew cleanup --prune=all -s && brew autoremove && sketchybar --trigger system_woke && mas outdated && mas upgrade && brew doctor'
